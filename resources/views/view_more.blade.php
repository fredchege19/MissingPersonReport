            ...
            <div class="card text-left">
                        ...
                        <div class="table-responsive">
											...
											<tbody>
                                                   ...
                                                   <tr><td><b>ID:</b> {{$ticket->id}}</td></tr>
                                                    <tr><td><b>Full Name:</b>  {{$ticket->fullName}}</td></tr>
                                                    <tr><td><b>Telephone:</b> {{$ticket->homeNumber}}</td></tr>
                                                    <tr><td><b>Phone:</b> {{$ticket->mobile}}</td></tr>
                                                    <tr><td><b>Clothing:</b> {{$ticket->clothing}}</td></tr>
                                                    <tr><td><b>Last Seen:</b> {{$ticket->lastSeen}}</td></tr>
                                                    <tr><td><b>Steps Taken:</b> {{$ticket->StepsTaken}}</td></tr>
                                                    <tr><td><b>Relationship:</b> {{$ticket->relationship}}</td></tr>
                                                    <tr><td><b>Description:</b> {{$ticket->description}}</td></tr>
                                                    <tr><td><b>Image:</b> <img height="100px" src="../uploads/{{$ticket->image}}"></td></tr>
...
<script src="../assets/js/common-bundle-script.js"></script>
    ...
    <script>
            @if(session()->has('notif'))
                toastr.success("Repport Created Successfully", "Process Completed")
            @endif
